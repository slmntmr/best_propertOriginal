package com.team02.best_properta.payload.messages;
...
public class ErrorMessages {
    ...
    public static final String NOT_FOUND_CATEGORY_MESSAGE = "ERROR : Category with this field %s not found";
    public static final String NOT_FOUND_CATEGORY_PROPERTYKEY_MESSAGE = "ERROR : CategoryPropertyKey with this field %s not found";



    public static final String ADVERT_NOT_FOUND_MESSAGE ="Error: Advert with id %s not found";
    public static final String IMAGE_NOT_FOUND_MESSAGE ="Error: Image with id %s not found";
    public static final String IMAGE_NOT_SAVED_MESSAGE ="Error: Failed to save image";
